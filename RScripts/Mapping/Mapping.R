...
locsRaw=read.csv("pleiades-locations.csv",stringsAsFactors=F,header=T,sep=',')
...
for (i in 1:nrow(features)) {
  ...
  for (ii in 1:nrow(periods)) {
    ...
    fName=paste0("Pleiades_",features[i,2],sprintf("%02d",ii),".png")
